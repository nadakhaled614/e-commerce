...
export default function NewPassword() {
    ...
    let validationSchema = Yup.object({
        ...
        newPassword: Yup.string().matches(/^[A-Z][a-z0-9]{5,10}$/, "Password must contain capital & small letters & numbers").required("password is required"),
    })
    ...
    return (
        <div>
            <h2 className='my-5 text-3xl'>Reset new password:</h2>
            ...
            <form className="max-w-md mx-auto" onSubmit={formik.handleSubmit}>
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.newPassword} type="password" id="newPassword" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
